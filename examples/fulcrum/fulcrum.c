...
int main()
{
    ...
    int32_t codec = kodoc_fulcrum;

    // Here we select the finite field to use.
    // For the Fulcrum codec, it is best to choose kodoc_binary8
    ...
    printf("Max expansion of the decoder factory: %d\n",
           kodoc_factory_max_expansion(decoder_factory));

    // Before building the encoder/decoder, you can change the number of
    // expansion symbols like this:
    //
    // kodoc_factory_set_expansion(encoder_factory, 2);
    // kodoc_factory_set_expansion(decoder_factory, 2);
